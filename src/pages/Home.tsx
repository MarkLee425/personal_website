...
const Home = () => {
  ...
  return (
    <div className='flex items-center text-center align-middle justify-center font-["arial"] font-bold text-2xl h-full flex-col gap-y-5 hover:cursor-default w-[50%]'>
      ...
      <p className="max-w-md text-sm text-gray-400 text-justify">
      ...
      <div className="text-base mt-8">
        <div className="flex flex-col gap-y-1 w-full items-center">
          <div className="flex flex-row items-center justify-center gap-x-3 mt-3 transition-opacity ease-in duration-700">
            <Link
              to={"about"}
              className={`rounded-md px-3 py-1.5 text-sm ${primaryButtonBgColor} ${primaryButtonTextColor} font-normal tracking-wider hover:bg-gray-200 hover:ease-in hover:duration-75`}
            >
              Get Started
            </Link>
            <Link
              ...
              download={true}
              target="_blank"
              className={`border-[1px] border-gray rounded-md px-3 py-1.5 text-sm ${secondaryButtonBgColor} ${secondaryButtonBgColor} font-normal tracking-wider flex items-center align-middle hover:bg-gray-800`}
            >
              <p>View My Resume</p>
