type ThemeProps =
  ...
  | "secondaryTextColor"
  | "hoverTextColor"
  | "blockSecondaryBorderColor"
  | "dotPrimaryBackgroundColor"
  | "dotSecondaryBackgroundColor"
  | "hoverTertiaryButtonBgColor"
...
export class ThemeColorController {
  ...
  private readonly THEME: TThemeConfiguration = {
    dark: {
      ...
      hoverTertiaryButtonBgColor: "hover:bg-purple-500",
      tertiaryButtonBgColor: "bg-purple-800",
    },
    light: {
      bgColor: "bg-[#ffffff]",
      ...
      hoverTertiaryButtonBgColor: "hover:bg-purple-400",
      tertiaryButtonBgColor: "bg-purple-500",
    },
  };
