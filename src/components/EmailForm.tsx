    ...
    <>
      <form onSubmit={submitHandler}>
        <div className="flex justify-center text-center align-middle justify-items-center gap-x-4 py-10 font-mono tracking-wide">
          <h1 className={`${style.textColor} text-3xl hover:text-orange-400`}>
            Email me
          </h1>
        ...
        <div className="w-full h-fit flex items-center align-middle justify-center mb-3">
          {!isLoading ? (
            <button
              type="submit"
              className={`flex justify-center items-center ${style.hoverTertiaryButtonBgColor} ${style.tertiaryButtonBgColor} text-white py-2 px-4 rounded-md w-fit text-sm font-normal tracking-wider hover:ease-in hover:duration-75`}
            >
              <p>Send</p>
              <Send className="ml-2" />
            </button>
